...
# ------------------------- Chat Message Model -------------------------
class ChatMessage:
    def __init__(self, user_dataset_id, role, content):
    ...
    @staticmethod
    def get_user_messages(user_dataset_id):
        return list(db.chat_messages.find({'user_dataset_id': user_dataset_id}).sort('timestamp', 1))
